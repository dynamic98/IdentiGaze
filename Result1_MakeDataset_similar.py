...
if __name__ == '__main__':
    ...
    whole_dataframe.to_csv('data/Result1/Similar_All.csv', index=False)
    raw_gaze_dataframe.to_csv('data/Result1/Similar_RawGaze.csv', index=False)
    eye_movement_dataframe.to_csv('data/Result1/Similar_EyeMovement.csv', index=False)
    fixation_dataframe.to_csv('data/Result1/Similar_Fixation.csv', index=False)
    saccade_dataframe.to_csv('data/Result1/Similar_Saccade.csv', index=False)
    MFCC_dataframe.to_csv('data/Result1/Similar_MFCC.csv', index=False)
    pupil_dataframe.to_csv('data/Result1/Similar_Pupil.csv', index=False)
