...
if __name__ == '__main__':
    ...
    for participant in participant_dict:
        ...
        for idx, foldername in tqdm(enumerate(p_tasklist)):
            ...
            for iter in range(1,101):
                ...
                data_dict = get_fixation_saccade_XY(bc_stimuli)
    ...
    whole_dataframe_task1.to_csv('data/blue_rawdata_fs_task1.csv', index=False)
    whole_dataframe_task2.to_csv('data/blue_rawdata_fs_task2.csv', index=False)
